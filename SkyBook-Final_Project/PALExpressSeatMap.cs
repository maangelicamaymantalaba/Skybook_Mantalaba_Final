...
{
    public partial class PALExpressSeatMap : Form
    {
        ...
        public PALExpressSeatMap(string travelClass, string airline, string dest, string flightNumber, string pointA, string pointB)
        {
            InitializeComponent();
            InitializeSeatMap();
        ...
        private void InitializeSeatMap()
        {
            ...
            seatButtons.Add("A12", A12);
            seatButtons.Add("B12", B12);
            seatButtons.Add("C12", C12);
            seatButtons.Add("D12", D12);
            seatButtons.Add("E12", E12);
            seatButtons.Add("F12", F12);
        ...
        private void CmbClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (currentClass)
            {
                case "First Class":
                    ...
                    break;
                case "Business":
                    EnableSeats(new List<string> { "A2", "B2", "C2", "A3", "B3", "C3" });
                    break;
                case "Economy":
                    var economySeats = new List<string>();
                    for (int i = 4; i <= 11; i++)
                    {
                        economySeats.Add($"A{i}");
                    ...
                    economySeats.AddRange(new[] { "A12", "B12", "C12", "D12", "E12", "F12" });
