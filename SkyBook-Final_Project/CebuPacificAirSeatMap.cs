...
{
    public partial class CebuPacificAirSeatMap : Form
    {
        ...
        public CebuPacificAirSeatMap(string travelClass, string airline, string dest, string flightNumber, string pointA, string pointB)
        {
            InitializeComponent();
            InitializeSeatMap();
        ...
        private void CebuPacificAirSeatMap_Load(object sender, EventArgs e)
        {
